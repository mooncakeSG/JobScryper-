  ...
  useEffect(() => {
    setTimeout(() => {
      ...
      setApplicationStatus([
        { name: "Applied", value: 45, color: themeColors.blue },
        { name: "Under Review", value: 25, color: themeColors.yellow },
        { name: "Interview", value: 15, color: themeColors.green },
        { name: "Rejected", value: 12, color: themeColors.red },
        { name: "Offer", value: 3, color: themeColors.purple },
      ]);
      setJobTypes([
            ...
            <CardContent className="pt-2 pb-4">
              {loading
                ...
                ? <div className="flex flex-col items-center justify-center h-[300px]">
                    ...
                    <h3 className="text-lg font-semibold mb-2">No data</h3>
                    <p className="text-gray-500">Job type analytics will appear here.</p>
                  </div>
                : <ResponsiveContainer width="100%" height={300}>
                    <LineChart data={jobTypes}>
                      ...
                      <YAxis />
                      <Tooltip />
                      <Line type="monotone" dataKey="applications" stroke={themeColors.blue} strokeWidth={2} />
                    </LineChart>
                  </ResponsiveContainer>}
            </CardContent>
          </Card>
